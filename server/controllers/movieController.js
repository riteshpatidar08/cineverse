...
//       path: "movie",
//       select:
//         "title poster certificate language duration genres",
//     })
//     .lean();
...
//   shows.forEach((show) => {
//     const theaterId =
//       show.theater.toString();

//     const theaterData =
//       theaterMap.get(theaterId);
...
//     // Create movie group
//     if (
//       !theaterData.movies.has(movieId)
//     ) {
//       theaterData.movies.set(
//         movieId,
//         {
//           movie: {
//             _id: show.movie._id,
...
//     const totalSeats =
//       show.seatStatus?.length || 0;

//     const availableSeats =
//       show.seatStatus?.filter(
//         (seat) => !seat.isBooked
//       ).length || 0;
